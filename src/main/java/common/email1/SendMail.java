...
public class SendMail {
    ...
    public static String myEmailAccount = "2532413887@qq.com";
    public static String myEmailPassword = "phlxksltaefwdjig";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "2532413887@qq.com";
