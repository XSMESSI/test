...
public class ExcelDropDown11 {
    ...
    private static String[] provinceList = {"广东省", "河南省", "湖北省"};
    private static String[] gzProvinceList = {"广州", "深圳", "珠海"};
    private static String[] hnProvinceList = {"郑州", "洛阳", "济源"};
    private static String[] hnProvinceList4 = {"武汉", "襄阳", "黄石"};
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            fileOut = new FileOutputStream("E:\\A徐慎\\测试文件夹\\三级联动\\" + filename);
...
//以下行设置城市名称列表
        ...
        creatRow(cityNameRow, hnProvinceList4);
//名称管理
//第一行设置性别信息
...
//以后动态大小设置省份对应的城市列表
        ...
        creatExcelNameList(workbook, provinceList[2], 5, hnProvinceList4.length, true);
//设置隐藏页标志
...
//城市选项添加验证数据
                    ...
                    DataValidation date_validation = getDataValidationByDate(3,4);
