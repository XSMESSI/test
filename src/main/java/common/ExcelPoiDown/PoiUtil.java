...
//        HSSFWorkBook.setSheetHidden(1, true);
    ...
    private static void writeDropDownData(HSSFWorkbook hssfWorkBook, HSSFSheet sheet, List<String> list, String name) {
        ...
        // 创建数据规则
        initGenderMapping(hssfWorkBook, sheet.getSheetName(), list.size(), name);
    }
    ...
    public static void export(String filePath, List<String> headers, List<String> mapOnList, List list) {
    }
...
//            //非空判断
//            Cell c0 = r.getCell(0, Row.RETURN_BLANK_AS_NULL);
//            if (c0 != null) {
//                // 将区域编号的cell中的内容当做字符串处理
//                r.getCell(0).setCellType(HSSFCell.CELL_TYPE_STRING);
//                rowList.add(r.getCell(0).getStringCellValue());
//            }
//            Cell c1 = r.getCell(1, Row.RETURN_BLANK_AS_NULL);
//            if (c1 != null) {
...
//                break;
//            }
//            Cell c2 = r.getCell(2, Row.RETURN_BLANK_AS_NULL);
//            if (c2 != null) {
//                r.getCell(2).setCellType(HSSFCell.CELL_TYPE_STRING);
//                rowList.add(r.getCell(2).getStringCellValue());
//            }
//            Cell c3 = r.getCell(3, Row.RETURN_BLANK_AS_NULL);
//            if (c3 != null) {
//                r.getCell(3).setCellType(HSSFCell.CELL_TYPE_STRING);
//                rowList.add(r.getCell(3).getStringCellValue());
//            }
//            Cell c4 = r.getCell(4, Row.RETURN_BLANK_AS_NULL);
//            if (c4 != null) {
//                r.getCell(4).setCellType(HSSFCell.CELL_TYPE_STRING);
//                rowList.add(r.getCell(4).getStringCellValue());
//            }
//            Cell c5 = r.getCell(5, Row.RETURN_BLANK_AS_NULL);
//            if (c5 != null) {
//                r.getCell(5).setCellType(HSSFCell.CELL_TYPE_STRING);
